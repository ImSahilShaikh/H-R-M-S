...
public class Hrmnotice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hrmnotice);
        ...
        pd = new ProgressDialog(Hrmnotice.this);
        pd.setMessage("Fethcing Teacher's Notice Info ------ > ");
        pd.setTitle("Wait ");
        ...
        protected void onPostExecute(Double result) {
            ...
            for (int i = 1; i < count; i++) {
                ...
                for (String text : colText) {
                    TextView tv = new TextView(Hrmnotice.this);
