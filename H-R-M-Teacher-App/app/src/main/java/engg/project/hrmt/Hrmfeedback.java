...
public class Hrmfeedback extends AppCompatActivity {
    Button bstore;
    TextView tid, tdate;
    EditText tdetails;
    int count = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hrmfeedback);
        ...
        bstore.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                pd = new ProgressDialog(Hrmfeedback.this);
                pd.setMessage("Saving Feedback ------ > ");
                pd.setTitle("Wait ");
                pd.setProgressStyle(ProgressDialog.STYLE_SPINNER);
                pd.show();
                new Hrmfeedback.MyAsyncTask().execute("HRM");
    ...
    private class MyAsyncTask extends AsyncTask<String, Integer, Double> {
        ...
        protected void onPostExecute(Double result) {
            Toast toast = Toast
                    .makeText(
                            Hrmfeedback.this,
                            "FEEDBACK INFO STORED SUCCESSFULLY",
                            Toast.LENGTH_LONG);
            toast.show();
            pd.dismiss();
        }
