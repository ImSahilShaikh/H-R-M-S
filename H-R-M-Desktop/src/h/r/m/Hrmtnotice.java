...
public class Hrmtnotice extends javax.swing.JFrame {
    ...
    public void connect() {
        try {
            ...
            spid = "1T7rXcOQJ8zRXmF-z7bqJoqfd3UJHHpplWpBmKbNuVFU";
            range = "A:B";
...
/*
  ...
  */
            ...
            Logger.getLogger(Hrmtnotice.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("TEACHERS NOTICE MASTER");
    ...
    private void bremoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bremoveActionPerformed
        ...
        JOptionPane.showMessageDialog(new Hrmtnotice(), "Data deleted Successfully");
        this.dispose();
    ...
    private void baddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_baddActionPerformed
        ...
        try {
            ...
            service.spreadsheets().values()
             ...
             //lname.add(data);
             lname.add(sndate);
            JOptionPane.showMessageDialog(new Hrmtnotice(), "DATA SAVED SUCCESSFULLY");
        } catch (Exception ex) {
            Logger.getLogger(Hrmtnotice.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new Hrmtnotice().setVisible(true);
