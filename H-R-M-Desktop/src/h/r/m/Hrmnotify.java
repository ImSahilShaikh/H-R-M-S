...
public class Hrmnotify extends javax.swing.JFrame {
...
/*
            ...
            Logger.getLogger(Hrmnotify.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("GENRAL NOTIFICATION MASTER");
    ...
    private void bremoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bremoveActionPerformed
        ...
        JOptionPane.showMessageDialog(new Hrmnotify(), "Data deleted Successfully");
        this.dispose();
    ...
    private void baddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_baddActionPerformed
        ...
        try {
            ...
            service.spreadsheets().values()
             ...
             lname.add(data);
            lname.add(sndate);
            JOptionPane.showMessageDialog(new Hrmnotify(), "DATA SAVED SUCCESSFULLY");
        } catch (Exception ex) {
            Logger.getLogger(Hrmnotify.class.getName()).log(Level.SEVERE, null, ex);
        }
